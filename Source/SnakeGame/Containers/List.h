...
public:
     ...
     */
    bool InsertNode(const ElementType& InElement, TDoubleLinkedListNode* NodeToInsertBefore = nullptr) { return InsertNode(new TDoubleLinkedListNode(InElement), NodeToInsertBefore); }
