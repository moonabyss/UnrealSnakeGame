...
public:
    ...
    FString CurrentGameSpeedOption() const { return CurrentGameSpeed.Name; }
    ...
    float GameSpeed() const { return CurrentGameSpeed.Value; }
...
private:
    ...
    const TMap<EGameSpeed, FSpeedData> GameSpeeds{
        {EGameSpeed::Worm,   {"Worm", 0.2f}    },
        {EGameSpeed::Snake,  {"Snake", 0.1f}   },
        {EGameSpeed::Python, {"Python", 0.075f}},
    };
    ...
    FSpeedData CurrentGameSpeed{GameSpeeds[EGameSpeed::Snake]};
